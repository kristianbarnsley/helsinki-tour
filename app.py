...
challenges = [
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\Sederholm House.m4a",
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\Market Square quay viewpoint.m4a",
            "description": "Audio Tour"
        },
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\Old Market hall (Vanha kauppahalli).m4a",
            "description": "Audio Tour"
        },
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\Bilingual St name signs.m4a",
            "description": "Audio Tour"
        },
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\Havas Amanda Fountain.m4a",
            "description": "Audio Tour"
        },
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\Kappeli Restaraunt.m4a",
            "description": "Audio Tour"
        },
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\Esplanadi Park.m4a",
            "description": "Audio Tour"
        },
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\Old Church Park.m4a",
            "description": "Audio Tour"
        },
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\Presidential Palace.m4a",
            "description": "Audio Tour"
        },
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\Helsinki Cathedral.m4a",
            "description": "Audio Tour"
        },
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\House of Estates (1).m4a",
            "description": "Audio Tour",
            "additional_audio" : ["..\media\House of Estates (2).m4a", "..\media\House of Estates (3).m4a"],
        },
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\WW2 (1).m4a",
            "description": "Audio Tour",
            "additional_audio" : ["..\media\WW2 (2).m4a", "..\media\WW2 (3).m4a"],
        },
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\Thirsty Scholar Pub.m4a",
            "description": "Audio Tour",
        },
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\Kiasma Museum & Amos Rex.m4a",
            "description": "Audio Tour",
        },
    ...
    },
    {
        ...
        "media": {
            "audio": "..\media\Senate Square Ensemble.m4a",
            "description": "Audio Tour",
        },
...
if 'media' in current:
    media = current['media']
    if 'video' in media:
        video_path = os.path.join("media", media['video'])
        if os.path.exists(video_path):
            st.write(media['description'])
            st.video(video_path)
    elif 'audio' in media:
        audio_path = os.path.join("media", media['audio'])
        if os.path.exists(audio_path):
            st.write(media['description'])
            st.audio(audio_path)
        if 'additional_audio' in media:
            for additional_path in media['additional_audio']:
